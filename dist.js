...
function __param(paramIndex, decorator_) {
  return function(target, key) {
    decorator_(target, key, paramIndex);
  };
}
  ...
  "node_modules/.pnpm/recast@0.23.11/node_modules/recast/lib/util.js"(exports2) {
    ...
    function fixFaultyLocations(node, lines) {
      ...
      if (loc && node.decorators) {
        node.decorators.forEach(function(decorator_) {
          expandLoc(loc, decorator_.loc);
        });
      } else if (node.declaration && isExportDeclaration(node)) {
        node.declaration.loc = null;
        var decorators = node.declaration.decorators;
        if (decorators) {
          decorators.forEach(function(decorator_) {
            expandLoc(loc, decorator_.loc);
          });
        }
